...
#               Rechtecke, Kreise, Pfeile, Text, Freihand), Undo/Redo, Farbwahl,
#               variablen Liniendicken, Textgrößen und PNG-Export. Unterstützt
#               sowohl den normalen Modus als auch einen JSON-basierten
